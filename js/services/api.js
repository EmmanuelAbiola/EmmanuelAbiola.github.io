  ...
  var data = [
    {
      id: 1,
      title: 'Scoreboard',
      background_image: 'img/scoreboard.png',
      timestamp: '1/06/2017',
      description: 'Built a Scoreboard in React.js. The scoreboard is a simple application we can use when playing board or card games. It\'ll allow us to add and remove players from our game and keep each player score by increasing or decreasing a score counter for the player. It includes dynamic information like the total number of players and points, and even contains a simple stopwatch that can be used to keep track of turn time.',
       project_url: 'https://github.com/EmmanuelAbiola/Scoreboard'
    },
    {
      id: 2,
      title: 'Maps',
    ...
    },
    {
      ...
      project_url:'https://github.com/EmmanuelAbiola/patient0'
    },
    {
      id: 6,
